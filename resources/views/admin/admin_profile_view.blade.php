                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="image" autocomplete="off"
                                    value="{{ $ProfileData->photo }}" name="photo">
                            </div>
                            <div class="mb-3">
                                <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ?
                        url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" id="showImage" alt="profile">
